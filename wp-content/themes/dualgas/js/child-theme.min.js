...
/*!
	  ...
	  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
	  */
!function(e,t){e.exports=function(e,t,n,i){const s=e=>e&&"object"==typeof e&&"default"in e?e:{default:e},o=s(t),r=s(n),a=s(i),l="tab",c=".bs.tab",u=`hide${c}`,d=`hidden${c}`,f=`show${c}`,h=`shown${c}`,p=`click${c}`,g=`keydown${c}`,m=`load${c}`,_="ArrowLeft",b="ArrowRight",v="ArrowUp",y="ArrowDown",w="active",x="fade",E="show",A="dropdown",T=".dropdown-toggle",O=".dropdown-menu",C=":not(.dropdown-toggle)",k='.list-group, .nav, [role="tablist"]',D=".nav-item, .list-group-item",L='[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]',S=`.nav-link${C}, .list-group-item${C}, [role="tab"]${C}, ${L}`,j=`.${w}[data-bs-toggle="tab"], .${w}[data-bs-toggle="pill"], .${w}[data-bs-toggle="list"]`;class P extends a.default{constructor(e){super(e),this._parent=this._element.closest(k),this._parent&&(this._setInitialAttributes(this._parent,this._getChildren()),o.default.on(this._element,g,(e=>this._keydown(e))))}static get NAME(){return l}show(){const e=this._element;if(this._elemIsActive(e))return;const t=this._getActiveElem(),n=t?o.default.trigger(t,u,{relatedTarget:e}):null;o.default.trigger(e,f,{relatedTarget:t}).defaultPrevented||n&&n.defaultPrevented||(this._deactivate(t,e),this._activate(e,t))}_activate(t,n){if(!t)return;t.classList.add(w),this._activate(e.getElementFromSelector(t));const i=()=>{"tab"===t.getAttribute("role")?(t.removeAttribute("tabindex"),t.setAttribute("aria-selected",!0),this._toggleDropDown(t,!0),o.default.trigger(t,h,{relatedTarget:n})):t.classList.add(E)};this._queueCallback(i,t,t.classList.contains(x))}_deactivate(t,n){if(!t)return;t.classList.remove(w),t.blur(),this._deactivate(e.getElementFromSelector(t));const i=()=>{"tab"===t.getAttribute("role")?(t.setAttribute("aria-selected",!1),t.setAttribute("tabindex","-1"),this._toggleDropDown(t,!1),o.default.trigger(t,d,{relatedTarget:n})):t.classList.remove(E)};this._queueCallback(i,t,t.classList.contains(x))}_keydown(t){if(![_,b,v,y].includes(t.key))return;t.stopPropagation(),t.preventDefault();const n=[b,y].includes(t.key),i=e.getNextActiveElement(this._getChildren().filter((t=>!e.isDisabled(t))),t.target,n,!0);i&&(i.focus({preventScroll:!0}),P.getOrCreateInstance(i).show())}_getChildren(){return r.default.find(S,this._parent)}_getActiveElem(){return this._getChildren().find((e=>this._elemIsActive(e)))||null}_setInitialAttributes(e,t){this._setAttributeIfNotExists(e,"role","tablist");for(const e of t)this._setInitialAttributesOnChild(e)}_setInitialAttributesOnChild(e){e=this._getInnerElement(e);const t=this._elemIsActive(e),n=this._getOuterElement(e);e.setAttribute("aria-selected",t),n!==e&&this._setAttributeIfNotExists(n,"role","presentation"),t||e.setAttribute("tabindex","-1"),this._setAttributeIfNotExists(e,"role","tab"),this._setInitialAttributesOnTargetPanel(e)}_setInitialAttributesOnTargetPanel(t){const n=e.getElementFromSelector(t);n&&(this._setAttributeIfNotExists(n,"role","tabpanel"),t.id&&this._setAttributeIfNotExists(n,"aria-labelledby",`#${t.id}`))}_toggleDropDown(e,t){const n=this._getOuterElement(e);if(!n.classList.contains(A))return;const i=(e,i)=>{const s=r.default.findOne(e,n);s&&s.classList.toggle(i,t)};i(T,w),i(O,E),n.setAttribute("aria-expanded",t)}_setAttributeIfNotExists(e,t,n){e.hasAttribute(t)||e.setAttribute(t,n)}_elemIsActive(e){return e.classList.contains(w)}_getInnerElement(e){return e.matches(S)?e:r.default.findOne(S,e)}_getOuterElement(e){return e.closest(D)||e}static jQueryInterface(e){return this.each((function(){const t=P.getOrCreateInstance(this);if("string"==typeof e){if(void 0===t[e]||e.startsWith("_")||"constructor"===e)throw new TypeError(`No method named "${e}"`);t[e]()}}))}}return o.default.on(document,p,L,(function(t){["A","AREA"].includes(this.tagName)&&t.preventDefault(),e.isDisabled(this)||P.getOrCreateInstance(this).show()})),o.default.on(window,m,(()=>{for(const e of r.default.find(j))P.getOrCreateInstance(e)})),e.defineJQueryPlugin(P),P}(r(),c(),S(),w())}(qt);var Vt=qt.exports,Qt={exports:{}};
/*!
	  * Bootstrap toast.js v5.2.3 (https://getbootstrap.com/)
	  * Copyright 2011-2022 The Bootstrap Authors (https://github.com/twbs/bootstrap/graphs/contributors)
	  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
	  */
!function(e,t){e.exports=function(e,t,n,i){const s=e=>e&&"object"==typeof e&&"default"in e?e:{default:e},o=s(t),r=s(n),a="toast",l=".bs.toast",c=`mouseover${l}`,u=`mouseout${l}`,d=`focusin${l}`,f=`focusout${l}`,h=`hide${l}`,p=`hidden${l}`,g=`show${l}`,m=`shown${l}`,_="fade",b="hide",v="show",y="showing",w={animation:"boolean",autohide:"boolean",delay:"number"},x={animation:!0,autohide:!0,delay:5e3};class E extends r.default{constructor(e,t){super(e,t),this._timeout=null,this._hasMouseInteraction=!1,this._hasKeyboardInteraction=!1,this._setListeners()}static get Default(){return x}static get DefaultType(){return w}static get NAME(){return a}show(){if(o.default.trigger(this._element,g).defaultPrevented)return;this._clearTimeout(),this._config.animation&&this._element.classList.add(_);const t=()=>{this._element.classList.remove(y),o.default.trigger(this._element,m),this._maybeScheduleHide()};this._element.classList.remove(b),e.reflow(this._element),this._element.classList.add(v,y),this._queueCallback(t,this._element,this._config.animation)}hide(){if(!this.isShown())return;if(o.default.trigger(this._element,h).defaultPrevented)return;const e=()=>{this._element.classList.add(b),this._element.classList.remove(y,v),o.default.trigger(this._element,p)};this._element.classList.add(y),this._queueCallback(e,this._element,this._config.animation)}dispose(){this._clearTimeout(),this.isShown()&&this._element.classList.remove(v),super.dispose()}isShown(){return this._element.classList.contains(v)}_maybeScheduleHide(){this._config.autohide&&(this._hasMouseInteraction||this._hasKeyboardInteraction||(this._timeout=setTimeout((()=>{this.hide()}),this._config.delay)))}_onInteraction(e,t){switch(e.type){case"mouseover":case"mouseout":this._hasMouseInteraction=t;break;case"focusin":case"focusout":this._hasKeyboardInteraction=t}if(t)return void this._clearTimeout();const n=e.relatedTarget;this._element===n||this._element.contains(n)||this._maybeScheduleHide()}_setListeners(){o.default.on(this._element,c,(e=>this._onInteraction(e,!0))),o.default.on(this._element,u,(e=>this._onInteraction(e,!1))),o.default.on(this._element,d,(e=>this._onInteraction(e,!0))),o.default.on(this._element,f,(e=>this._onInteraction(e,!1)))}_clearTimeout(){clearTimeout(this._timeout),this._timeout=null}static jQueryInterface(e){return this.each((function(){const t=E.getOrCreateInstance(this,e);if("string"==typeof e){if(void 0===t[e])throw new TypeError(`No method named "${e}"`);t[e](this)}}))}}return i.enableDismissTrigger(E),e.defineJQueryPlugin(E),E}(r(),c(),w(),A())}(Qt);var Jt,Kt,Xt,Yt=Qt.exports;Jt=navigator.userAgent.toLowerCase().indexOf("webkit")>-1,Kt=navigator.userAgent.toLowerCase().indexOf("opera")>-1,Xt=navigator.userAgent.toLowerCase().indexOf("msie")>-1,(Jt||Kt||Xt)&&document.getElementById&&window.addEventListener&&window.addEventListener("hashchange",(function(){var e,t=location.hash.substring(1);/^[A-z0-9_-]+$/.test(t)&&(e=document.getElementById(t))&&(/^(?:a|select|input|button|textarea)$/i.test(e.tagName)||(e.tabIndex=-1),e.focus())}),!1),function(e){e(document).ready((function(){var t=e(".hamburger");t.on("click",(function(n){t.toggleClass("is-active"),t.hasClass("is-active")?(e("#myNav").css("width","100%"),e("body").css("overflow","hidden")):(e("#myNav").css("width","0%"),e("body").css("overflow","auto"))})),e(document).on("keydown",(function(n){"Escape"!==n.key&&27!==n.keyCode||t.hasClass("is-active")&&(t.removeClass("is-active"),e("#myNav").css("width","0%"),e("body").css("overflow","auto"))}))}));var t="https://www.dualgas.es";e("#anonimo").on("click",(function(t){e(".div-anon").toggleClass("hide show")})),e("#myModal").on("shown.bs.modal",(function(){e("#myInput").trigger("focus")})),e("#iniciar-canal").click((function(n){n.preventDefault(),e.ajax({type:"POST",url:t+"/controllers/crearCaso.php",data:{password:e("#modal-password").val()},success:function(e){var n=JSON.parse(e);1==n.ok?window.location.replace(t+"/chat-canal-comunicacion"):alert(n.message)},error:function(e){alert("Ha ocurrido un error")}})})),e("#recuperar-canal").click((function(n){n.preventDefault(),e.ajax({type:"POST",url:t+"/controllers/recuperarCanal.php",data:{idCaso:e("#modal-id-caso").val(),password:e("#modal-password-caso").val()},success:function(e){var n=JSON.parse(e);1==n.ok?window.location.replace(t+"/chat-canal-comunicacion"):alert(n.message)},error:function(e){alert("Ha ocurrido un error")}})})),e("#enviar-mensaje").click((function(n){n.preventDefault(),e.ajax({type:"POST",url:t+"/controllers/enviarMensaje.php",data:{mensaje:e("#input-chat-text").val(),codigo:e("#input-codigo-caso").val(),id:e("#input-id-caso").val(),id_agente:e("#input-id-agente").val()},success:function(e){var n=JSON.parse(e);1==n.ok?window.location.replace(t+"/chat-canal-comunicacion"):alert(n.message)},error:function(e){alert("Ha ocurrido un error")}})})),e("#log-out").click((function(n){n.preventDefault(),e.ajax({type:"POST",url:t+"/controllers/cerrarSesionCaso.php",data:{cerrar:1},success:function(e){var n=JSON.parse(e);1==n.ok?window.location.replace(t+"/chat-canal-comunicacion"):alert(n.message)},error:function(e){alert("Ha ocurrido un error")}})})),e("#agent-login").click((function(n){n.preventDefault(),e.ajax({type:"POST",url:t+"/controllers/iniciarSesion.php",data:{nick:e("#agent-nick").val(),password:e("#agent-password").val()},success:function(e){var n=JSON.parse(e);1==n.ok?window.location.replace(t+"/admin-panel"):alert(n.message)},error:function(e){alert("Ha ocurrido un error")}})})),e(".acceder-chat").click((function(n){n.preventDefault(),e.ajax({type:"POST",url:t+"/controllers/recuperarCanal.php",data:{id:e(this).closest(".chat").attr("id")},success:function(e){var n=JSON.parse(e);1==n.ok?window.location.replace(t+"/chat-canal-comunicacion"):alert(n.message)},error:function(e){alert("Ha ocurrido un error")}})})),e(".button-cerrar-chat").click((function(n){n.preventDefault(),e.ajax({type:"POST",url:t+"/controllers/cerrarChat.php",data:{id:e(this).closest(".chat").attr("id")},success:function(e){var n=JSON.parse(e);1==n.ok?window.location.replace(t+"/admin-panel"):alert(n.message)},error:function(e){alert("Ha ocurrido un error")}})}))}(jQuery),e.Alert=T,e.Button=k,e.Carousel=N,e.Collapse=M,e.Dropdown=vt,e.Modal=Dt,e.Offcanvas=jt,e.Popover=Wt,e.Scrollspy=Bt,e.Tab=Vt,e.Toast=Yt,e.Tooltip=Rt}));
